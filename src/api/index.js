...
export const userLogin = (params) => {
  return http.fetchPost(`${baseUrl}/index/login`, params)
}
// 退出登陆
...
export const userInfo = (params) => {
  return http.fetchPost(`${baseUrl}/index/userInfo`, params)
}
// 注册账号
...
export const productHome = (params) => {
  return http.fetchGet(`${baseUrl}/index/productHome`, params)
}
