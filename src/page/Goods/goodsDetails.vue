  ...
  <div class="w store-content">
    <div class="gray-box">
      ...
      <div class="banner">
        ...
        <div class="buy">
          <y-button text="加入购物车"
                    @btnClick="addCart(product.productId,product.salePrice,product.productName,big)"
                    classStyle="main-btn"
    ...
    <div class="item-info">
      <y-shelf title="产品信息">
        <div slot="content">
          <div class="img-item" v-if="productMsg.length>0">
    ...
    methods: {
      ...
      _productDet (productId) {
        productDet({productId}).then(res => {
          ...
          this.product.limit_num = 3
          this.productMsg = res.data.descPieces || ''
          this.small = res.data.productSmallImage
          this.big = res.data.productImageBig
        })
      },
